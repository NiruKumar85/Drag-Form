...
const Header = () => {
  ...
  return (
    <header className="w-full h-[10vh] px-20 flex justify-between items-center bg-gradient-to-r from-purple-600 to-green-600 shadow-lg border-b border-gray-300">
